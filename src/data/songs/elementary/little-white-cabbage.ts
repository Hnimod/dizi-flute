...
export const song: Song = {
  ...
  tempo: 69,
  jianpu: `
( 5T 3 ) 3T | 2T - - V | ( 5T 3 ) ( [ 3T 2 ] ) | 1T - - V | ( 1T 3 ) 2T |
6,T - - V | 2T 1T ( [ 1T 6, ] ) | 5,T - - V | 2T 2T 3T | 2T - - V |
( 5T 3 ) ( [ 3T 2 ] ) | 1T - - V | ( 1T 3 ) 2T | 6,T - - V | ( 2T 1T ) ( [ 1T 6, ] ) |
5,T - - V | 6,T ( [ 1T 6, ] ) 5,T V | 6,T ( [ 1T 6, ] ) 5,T V | 6,T 2T ( [ 1T 6, ] ) | 5,T - - ||`,
