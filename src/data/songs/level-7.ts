...
export const level7Songs: Song[] = [
  {
    ...
    timeSignature: "4/4",
    tempo: 46,
    jianpu: `0 0 0 5, | ( 6, - - - 1 2 ) | ( 3 - - 2 1 6, ) | 5, - - - V |
...
( 6, - 1 2 ) | ( 3 - 5 3 ) | ( 2 - 1 6, ) | 1 - - - ||`,
  ...
  },
  {
    ...
    timeSignature: "4/4",
    tempo: 48,
    jianpu: `0 0 0 5, | ( 6, - 1 2 ) | ( 1 - 6, 5, ) | 6, - - - V |
