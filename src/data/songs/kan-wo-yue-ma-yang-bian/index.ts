...
export const song: Song = {
  ...
  jianpu: `
    ...
    [ 2 3 ] [ 5 6 ] bo 1 - V | [ (5,)6, die 6, ] [ die 6, 5, ] [ 6, ~( 1 ] [ 1 ~) 0 ] V | [ (2)3 da 3 ] [ da 3 bo 2 ] [ 1 ~( 2 ] [ 2 ~) 0 ] V | [ T 5 da 5 ] [ T 5 3 ] [ bo 6 ~( 3 ] [ 3 ~) 0 ] V |
    [ (1)2 die 2 ] [ da 2 1 ] [ 3 ~( 5 ] [ 5 ~) 0 ] V | bo 5. [ 3 ] (5)6 da 6 | [ ~( 5. [ 6 ] ] [ 5 4 ~) ] 3 V [ (3)(2)1 2 ] | 3. V [ 3 ] [ ~( 2 3 ] [ 5 6 ~) ] | bo 5 - - - V |
